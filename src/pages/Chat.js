  ...
  return (
    <div className='flex-container'>
      ...
      <div className={isAnyToggled ? 'chat' : 'offscreen'}>
        ...
        <svg className='chat-waves' id="visual" viewBox="0 0 1600 400" width="" height="">
